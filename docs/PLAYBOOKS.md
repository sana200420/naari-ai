...
- [ ] **Add cross-encoder reranking over the fused top 20** — *Done when* the Recall@1 improvement from reranking is measured and committed. Not yet started; fused Recall@1 (0.967) is already strong, so this is about the confidence-gate precision Lever 5 needs, not rescuing Phase 1's exit gate.
